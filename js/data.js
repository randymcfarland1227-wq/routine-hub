...
// Live TickTick mirror captured 2026-09-08. Existing Routine Hub-only entries stay in
...
const TICKTICK_ROUTINES = [
  ...
  { id: 'body-cardio-training', ticktickId: '6a9fb6ba8f08ecb120d19e23', category: 'body', dateAdded: '2026-01-01', focus: 'Cardio — Gym', why: 'To build endurance for summer and festival season', what: 'Complete the planned cardio session at the gym', frequency: 'Habit · Tue & Fri', freq: 2, duration: 'Two sessions a week', object: 'Gym and time', active: true, type: 'habit' },
  { id: 'body-abdominal-training', ticktickId: '6a9fb6da8f08ea0eca04480d', category: 'body', dateAdded: '2026-01-01', focus: 'Abdominal Training — Gym', why: 'To grow abdominal and internal muscles and sculpt physique', what: 'Complete the planned abdominal training at the gym', frequency: 'Habit · Mon & Wed', freq: 2, duration: 'Two sessions a week', object: 'Gym and time', active: true, type: 'habit' },
  ...
  { id: 'mind-open-job-search', ticktickId: '6a9fb6d68f08ecb120d1a125', category: 'organizing', dateAdded: '2026-09-08', focus: 'Daily Work & Income Flow', why: 'To keep required work and income-building actions together in one visible weekday task', what: 'Job: check Automation Pipeline postings and apply; browse and compile personally found postings and roles; check existing roles and applications. Resale: run the agent posting-stats update; list new items when needed; respond to inquiries; lower prices or offer bundles; ship items when needed; run the trending-items-to-acquire agent. Candles: complete the candle action.', frequency: 'Task · Mon–Fri', freq: 5, duration: 'Ten checklist items; when-needed items may be skipped when they do not apply', object: 'Job Hub, resale flow, and candle-making materials', active: true, type: 'task' },
  ...
  { id: 'organizing-side-hustle-progress', ticktickId: null, category: 'organizing', dateAdded: '2026-08-29', focus: 'Side Hustle Progress', why: 'To keep income-building experiments moving through small actions', what: 'Resale and candle work now live inside Daily Work & Income Flow', frequency: 'Covered by Daily Work & Income Flow', freq: 0, duration: 'Preserved reference', object: 'Selling or candle project materials', active: false, type: 'reference' },
  ...
  // Required tasks and explicitly scheduled guidance currently present in TickTick.
  { id: 'body-recovery-options', ticktickId: '6a9fb6d18f0852d54c2d7860', category: 'body', dateAdded: '2026-08-29', focus: 'Recovery: TENS/Massage Gun/Dry Brush/Chair/Stretch-Yoga/Relax', why: 'To respond to the body’s actual recovery needs without six separate habits', what: 'Choose the recovery support your body needs tonight; one option is enough', frequency: 'Habit · Daily · 11 PM', freq: 7, duration: 'One chosen recovery option', object: 'Recovery tools', active: true, type: 'habit' },
...
const MOTIVATION_MAP_GROUPS = [
  ...
  { area: 'occupation', label: 'Side Hustles — Daily', items: [
    { title: 'Clothes and Object Selling', type: 'task', routineId: 'mind-open-job-search' },
    { title: 'Candles', type: 'task', routineId: 'mind-open-job-search' },
  ]},
