...
const TICKTICK_ROUTINES = [
  ...
  { id: 'mind-open-job-search', ticktickId: '6a9fb6d68f08ecb120d1a125', category: 'organizing', dateAdded: '2026-09-08', focus: 'Daily Work & Income Flow', why: 'To keep required work and income-building actions together in one visible weekday task', what: 'Complete the Job Hub, Resale Flow, and Candle Making checklist items', frequency: 'Task · Mon–Fri', freq: 5, duration: 'Three checklist items', object: 'Job Hub, resale flow, and candle-making materials', active: true, type: 'task' },
